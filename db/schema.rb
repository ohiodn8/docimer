...
ActiveRecord::Schema.define(version: 2018_03_21_200548) do
  ...
  create_table "cmsadmins", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_cmsadmins_on_email", unique: true
    t.index ["reset_password_token"], name: "index_cmsadmins_on_reset_password_token", unique: true
  end
  ...
  create_table "designs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["body_color_id"], name: "index_designs_on_body_color_id"
  ...
  create_table "logotexts", force: :cascade do |t|
    t.string "text"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
